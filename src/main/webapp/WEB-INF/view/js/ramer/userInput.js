$( function() {
    $( "input[class=anim]" ).click(
            function() {
                var spanNode = $( this ).prev();
                $( spanNode ).css( "transform" ,
                        "scale(.5) translateY(-30px) translateX(-40%)" );
            } );
    $( "input[class=anim]" ).blur( function() {
        var spanNode = $( this ).prev();
        if ($.trim( $( this ).val() ).length > 0) {
            return;
        }
        $( spanNode ).css( "transform" , "scale(1)" );
    } );
    // $( "input[class=anim]" ).blur( function() {
    // var spanNode = $( this ).prev();
    // $( spanNode ).css( "transform" , "scale(1)" );
    ...
    // var valueStr = $( "input[name='email']" ).attr(
    // "value" );
