...
public class ForgetPassword{
    ...
    public String forwardForgetPassword(String email, Map<String, Object> map) {
     ...
     */
    @PutMapping("/user/forgetPass/sendMail")
    public void sendMailToResetPass(String email, HttpSession session,
    ...
    public String forgetPassword(String email,String password, String repassword, HttpSession session) {
