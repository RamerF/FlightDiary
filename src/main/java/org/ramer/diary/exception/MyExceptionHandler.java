...
public class MyExceptionHandler implements HandlerExceptionResolver{
    ...
    private static ModelAndView setMessage(ModelAndView modelAndView, Exception exception) {
        ...
        case "SQLExecException":
            errorMessage = (errorMessage == null || errorMessage == "") ? "系统无法执行当前操作，请稍后再试" : errorMessage;
            break;
        case "DefaultException":
            errorMessage = (errorMessage == null || errorMessage == "") ? "系统被程序猿玩儿坏啦，看看其他东东坏没  ^_^\"" : errorMessage;
            break;
        case "EmailExistException":
            errorMessage = (errorMessage == null || errorMessage == "") ? "邮箱已经有了！到底是不是你的！" : errorMessage;
            break;
        default:
